...
class Program
{
    ...
    { //función para agregar un estudiante
        ...
        while (true)
        {
            ...
            if (double.TryParse(input, out calificacion) && calificacion >= 0 && calificacion <= 100)
            {
                break;
            }
            else
            {
                Console.WriteLine("Entrada no válida. Por favor, ingrese un número entre 0 y 100.");
            }
        }
